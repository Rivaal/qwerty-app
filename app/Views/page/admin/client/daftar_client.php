...
<?= $this->section('title') ?>Client<?= $this->endSection('title') ?>
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Client /</span> Daftar Client</h4>
        <!-- Table -->
        <div class="card">
        ...
        <div class="offcanvas offcanvas-end" id="add-new-record">
            <div class="offcanvas-header border-bottom">
                <h5 class="offcanvas-title" id="exampleModalLabel">Client Baru</h5>
    ...
    if (dt_basic_table.length) {
        dt_basic = dt_basic_table.DataTable({
            ...
            buttons: [{
                ...
                {
                    text: '<i class="ti ti-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Tambah Client</span>',
        ...
        $('div.head-label').html('<h5 class="card-title mb-0">Daftar Client</h5>');
    }
});
</script>
