                    ...
                    <div class="header-row align-items-lg-stretch">
                        ...
                        <nav class="primary-menu style-ecommerce menu-spacing-margin">
                            ...
                            <ul class="menu-container">
                                <li class="dashboard menu-item"><a class="menu-link" href="<?= base_url(); ?>">
                                        <div>Beranda</div>
                                    </a></li>
                                <li class="gallery menu-item"><a class="menu-link" href="<?= base_url(); ?>">
                                        <div>Galeri</div>
                                    </a></li>
                                <li class="video menu-item"><a class="menu-link" href="<?= base_url(); ?>">
                                        <div>Video</div>
                                    </a></li>
                                <li class="catalog menu-item mega-menu"><a class="menu-link"
                                                        ...
                                                        <div class="widget">
                                                            ...
                                                            <div class="portfolio-item">
                                                                <div class="portfolio-image">
                                                                    <a href="#"><img
                                                                            src="<?= BASE_URL(); ?>/assets/userimg/trending1/1-1.png"
                                                                            alt="Graduation"></a>
                                                                    <div class="product-cart"><a href="#"><i
                                                                                class="icon-shopping-cart"></i></a>
                                                                    </div>
                                                                    <div class="product-quickview"><a href="#"
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top"
                                                                            title="Ini adalah deskripsinya"><i
                                                ...
                                                <ul class="sub-menu-container mega-menu-column col-lg-3">
                                                    <li class="menu-item">
                                                        <div class="widget">
                                                            ...
                                                            <h4 class="highlight-me">Katalog Pilihan</h4>
                                                                    ...
                                                                    <div class="grid-inner row g-0">
                                                                        <div class="col-auto">
                                                                            <div class="entry-image">
                                                                                <a href="#"><img
                                                                                        src="<?= BASE_URL(); ?>/assets/userimg/trending1/1-2.png"
                                                                                        alt="Image"></a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col ps-3">
                                                                            <div class="entry-title">
                                                                                <h4><a href="#">Photo Group</a>
                                                                                </h4>
                                                                            </div>
                                                                            <div class="entry-meta no-separator">
                                                                                <ul class="sub-menu-container">
                                                                                    <li class="color">Rp69.000</li>
                                                                                    <li class="menu-item">
                                                                ...
                                                                <div class="entry col-12">
                                                                    <div class="grid-inner row g-0">
                                                                        <div class="col-auto">
                                                                            <div class="entry-image">
                                                                                <a href="#"><img
                                                                                        src="<?= BASE_URL(); ?>/assets/userimg/trending1/1-3.png"
                                                                                        alt="Image"></a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col ps-3">
                                                                            <div class="entry-title">
                                                                                <h4><a href="#">Single Portrait</a>
                                                                                </h4>
                                                                            </div>
                                                                            <div class="entry-meta no-separator">
                                                                                <ul class="sub-menu-container">
                                                                                    <li class="color">Rp49.000</li>
                                                                                    <li class="menu-item">
                                                                                        <i class="icon-star3"></i>
                                                                                        <i class="icon-star3"></i>
                                                                                        <i class="icon-star3"></i>
                                                                ...
                                                                <div class="entry col-12">
                                                                    <div class="grid-inner row g-0">
                                                                        <div class="col-auto">
                                                                            <div class="entry-image">
                                                                                <a href="#"><img
                                                                                        src="<?= BASE_URL(); ?>/assets/userimg/trending1/1-4.png"
                                                                                        alt="Image"></a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col ps-3">
                                                                            <div class="entry-title">
                                                                                <h4><a href="#">Wedding Session</a>
                                                                                </h4>
                                                                            </div>
                                                                            <div class="entry-meta no-separator">
                                                                                <ul class="sub-menu-container">
                                                                                    <li class="color">Rp99.000</li>
                                                                                    <li class="menu-item">
                                                                                        <i class="icon-star3"></i>
                                                                                        <i class="icon-star3"></i>
                                                                                        <i class="icon-star3"></i>
                                                    ...
                                                    <li class="menu-item mega-menu-title"><a class="menu-link" href="#">
                                                        ...
                                                        <ul class="sub-menu-container">
                                                            <li class="menu-item"><a class="menu-link" href="#">
                                                                    <div><i class="icon-people-carry"></i>Wedding</div>
                                                                </a></li>
                                                            <li class="menu-item"><a class="menu-link" href="#">
                                                                    <div><i class="icon-line-camera"></i>Pre-Wedding
                                                                    </div>
                                                                </a></li>
                                                            <li class="menu-item"><a class="menu-link" href="#">
                                                                    <div><i class="icon-photo"></i>Portrait</div>
                                                                </a></li>
                                                            <li class="menu-item"><a class="menu-link" href="#">
                                                                    <div><i class="icon-group"></i>Photo Group</div>
                                                                </a></li>
                                                            <li class="menu-item"><a class="menu-link" href="#">
                                                                    <div><i class="icon-user4"></i>Single</div>
                                                                </a></li>
                                                            <li class="menu-item"><a class="menu-link" href="#">
                                                                    <div><i class="icon-food2"></i>Food Photography
                                                                    </div>
                                                                </a></li>
                                                            <li class="menu-item"><a class="menu-link" href="#">
                                                                    <div><i class="icon-tshirt"></i>Fashion</div>
                                                                </a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                ...
                                <li class="how-to menu-item"><a class="menu-link" href="#">
                                        <div>Cara Transaksi</div>
                                    </a></li>
                                <li class="contact-us menu-item"><a class="menu-link" href="#">
