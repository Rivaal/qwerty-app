    ...
    <div class="container clearfix">
        <div class="row align-items-center">
            <div class="col-12 col-lg">
                <h3>Dapatkan <span>10%</span> diskon dengan booking sebanyak 700K atau lebih. Gunakan kupon:
                    <span>QWERTY10</span>
                </h3>
                <span>Diskon berlaku untuk transaksi pertama pengguna baru dan pada waktu promo yang ditentukan.</span>
            </div>
            <div class="col-12 col-lg-auto mt-4 mt-lg-0">
                <a href="katalog" class="button button-large button-circle m-0">MULAI BOOKING</a>
            </div>
        </div>
    </div>
</div>
