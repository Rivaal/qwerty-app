                ...
                <div class="col-lg-6">
                    ...
                    <form id="billing-form" name="billing-form" class="row mb-0" action="#" method="post">
                        ...
                        <div class="col-md-12 form-group">
                            <label for="detail-client-lokasi">Lokasi:</label>
                            <input type="text" id="detail-client-lokasi" name="detail-client-lokasi" value=""
...
function checkEnable() {
    ...
    var lokasi = $('#detail-client-lokasi').val();
    if (tanggal_sesi != "" && lokasi != "") {
...
$('#button-proses').click(function(e) {
    e.preventDefault();
    var tgl, jam, lokasi, ctt, cart;
    tgl = $('#detail-tanggal-sesi').val();
    jam = $('#detail-jam-sesi').val();
    lokasi = $('#detail-client-lokasi').val();
