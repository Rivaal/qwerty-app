            ...
            <div class="row col-mb-50">
                <div class="col-md-7">
                    <div class="fancy-title title-bottom-border">
                        <h3>Pelunasan dapat dibayar dalam</h3>
                    </div>
                    <div id="countdown-ex3" class="countdown countdown-large" data-year="<?= $year ?>"
                        data-month="<?= $month ?>" data-day="<?= $day ?>" data-format="dHMS">
                    </div><br>
                    <p>Jika pembayaran belum lunas sebelum <?= $booking['tanggal_sesi'] ?>, pelunasan dapat dilakukan
                        saat jadwal pemotretan.
                    </p>


                    <div class="fancy-title title-bottom-border">
                        <h3>Cara pelunasan</h3>
                    </div>

                    <p>Anda dapat melakukan pelunasan dengan membayar sisa dari total biaya yaitu
                        sebesar <strong>Rp<?= number_format($lunas-$dp, 0, ",", "."); ?></strong>.</p>
                    <p>Tata cara pelunasan :</p>
                    ...
                    <div class="accordion accordion-bg">
                        ...
                        <div class="accordion-content">
                            <ul class="iconlist iconlist-color mb-0">
                                ...
                                <li><i class="icon-minus"></i>Masukkan nominal pelunasan sebesar
                                    Rp<?= number_format($lunas-$dp, 0, ",", "."); ?> dan klik konfirmasi</li>
                                <li><i class="icon-minus"></i>Pastikan nama penerima atas nama Rivaldo Saputra</li>
                                <li><i class="icon-minus"></i>Konfirmasikan pelunasan dengan memasukkan PIN GoPay</li>
                                <li><i class="icon-minus"></i>Setelah berhasil melakukan transfer GoPay, kamu akan
                                    menerima notifikasi</li>
                                <li><i class="icon-minus"></i>Screenshot bukti pelunasan kamu</li>
                                <li><i class="icon-minus"></i>Tekan tombol "Konfirmasi Pelunasan" pada halaman QWERTY
                                    Studio untuk mengkonfirmasi pelunasan dan lanjut ke tahap selanjutnya.</li>
                            </ul>
                        </div>
                        ...
                        <div class="accordion-content">
                            <ul class="iconlist iconlist-color mb-0">
                                ...
                                <li><i class="icon-minus"></i>Masukkan nominal pelunasan sebesar
                                    Rp<?= number_format($lunas-$dp, 0, ",", "."); ?> dan klik konfirmasi
                                </li>
                                <li><i class="icon-minus"></i>Pastikan nama penerimanya atas nama Rivaldo Saputra
                                </li>
                                <li><i class="icon-minus"></i>Konfirmasi pelunasan kamu dengan memasukan PIN Dana kamu
                                </li>
                                <li><i class="icon-minus"></i>Kamu akan mendapatkan notifikasi bahwa kamu telah berhasil
                                    melakukan transfer Dana
                                </li>
                                <li><i class="icon-minus"></i>Screenshoot bukti pelunasan kamu
                                </li>
                                <li><i class="icon-minus"></i>Tekan tombol "Konfirmasi Pelunasan" dihalaman QWERTY
                                    Studio untuk
                                    menkonfirmasi pelunasan kamu lalu ikuti tahap selanjutnya</li>
                            </ul>
                        </div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="col-12 form-group">
                        <button id="button-proses" class="button button-large w-100 m-0 button-blue"
                            onclick="confirm('<?= $booking['id_booking']; ?>');">Konfirmasi Pelunasan
...
function confirm(idbooking) {
    $.ajax({
        ...
        success: function(response) {
            window.location.replace("<?= base_url(); ?>/pelunasan/" + response.success);
        },
